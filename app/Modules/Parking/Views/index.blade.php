...
<div class="page-content container-fluid">
	...
	<div class="page-header">
        <h1 class="page-title">Parkings</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="breadcrumb-item active"><a href="#">Parkings</a></li>
        </ol>
        <div class="page-header-actions">

            <a href="{{ route('admin.parkings.create') }}"  class="btn btn-sm btn-primary btn-outline btn-round"  title="create">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table style="width: 100% !important" id="parking-datatable" class="table table-hover dataTable table-striped">
                    <thead>
                        <tr>
                            <th>SN</th>
							<th >Type</th>
...
<script>
    ...
    $(function(){
        dataTable = $('#parking-datatable').DataTable({
        dom: 'Bfrtip',
        "serverSide": true,
        buttons: [
        'copy', 'csv', 'excel', 'pdf', 'print'
        ],
        'ajax' : { url: "{{ route('admin.parkings.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
