...
<div class="page-content container-fluid">
	...
	<div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Teams</a></li>
        </ol>
        <div class="page-header-actions">

            <a href="{{ route('admin.teams.create') }}"  class="btn btn-sm btn-primary btn-outline btn-round"  title="create">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table style="width: 100% !important" id="team-datatable" class="table table-hover dataTable table-striped">
                    <thead>
                        <tr>
                            <th>SN</th>
{{--							<th >Image</th>--}}
...
<script>
    ...
    $(function(){
        dataTable = $('#team-datatable').DataTable({
        dom: 'Bfrtip',
        "serverSide": true,
        buttons: [
        'copy', 'csv', 'excel', 'pdf', 'print'
        ],
        'ajax' : { url: "{{ route('admin.teams.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
