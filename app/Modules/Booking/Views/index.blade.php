    ...
    $(function(){
        ...
        'ajax' : { url: "{{ route('admin.bookings.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
            ...
            columns: [
                ...
                { data: "full_name",name: "full_name"},{ data: "company_name",name: "company_name"},{ data: "postcode",name: "postcode"},{ data: "contact",name: "contact"},
                // { data: "email",name: "email"},
                // { data: "special_requirement",name: "special_requirement"},{ data: "parking_id",name: "parking_id"},{ data: "other",name: "other"},
