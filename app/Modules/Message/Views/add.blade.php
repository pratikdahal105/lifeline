...
@section('content')
    ...
    <div class="page-content container-fluid">
        <div class="page-header">
            <h1 class="page-title">Add Messages </h1>
            <ol class="breadcrumb">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <form role="form" action="{{ route('admin.messages.store') }}"  method="post">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <label for="subject">Subject</label><input type="text" name="subject" id="subject" class="form-control" ></div><div class="form-group">
