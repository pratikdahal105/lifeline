...
@section('content')
    <div class="page-content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="page-header-actions">
                ...
                <a href="{{ route('admin.permissions.create') }}" class="btn btn-sm btn-primary btn-outline btn-round"
                   title="create">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table style="width: 100% !important" id="permission-datatable"
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {
            ...
            dataTable = $('#permission-datatable').DataTable({
                dom: 'Bfrtip',
                // scrollX: true,
                "serverSide": true,
                buttons: [
                ...
                'ajax': {
                    url: "{{ route('admin.permissions.getdatajson') }}",
                    type: 'POST',
